      ...
      <div id="left_footer" class="col-sm-6">
        <ul>
          ...
          <li>
            <h5>Academia</h5>
            <ul>              
              <li><a href="{{url('news')}}">News and Event</a></li>
            ...
            <ul>
              ...
              <li>
                  <a href="http://www.facbook.com" target="_blank">
                      <img src="{{URL::asset('assets_files/images/img-fb.png')}}" alt="">
                  </a>
              </li>
              <li>
                  <a href="http://www.twitter.com" target="_blank">
                      <img src="{{URL::asset('assets_files/images/img-tw.png')}}" alt="">
                  </a>
              </li>
              <li>
                  <a href="http://www.youtube.com" target="_blank">
                      <img src="{{URL::asset('assets_files/images/img-dg.png')}}" alt="">
                  </a>
              </li>
              <li>
                  <a href="http://www.youtube.com" target="_blank">
                      <img src="{{URL::asset('assets_files/images/img-ut.png')}}" alt="">
                  </a>
              </li>
            </ul>
          </div>
